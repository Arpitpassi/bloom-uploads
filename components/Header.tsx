          ...
          <div className="flex items-center space-x-4">
            {walletType === "external" && (
              <button
                ...
                className="inline-flex items-center space-x-2 rounded-lg bg-red-600 px-4 py-2 text-sm font-medium text-white hover:bg-red-700 transition-all duration-200 hover:scale-105 shadow-lg hover:shadow-xl"
              >
